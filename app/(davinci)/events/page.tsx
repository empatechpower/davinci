  ...
  return (
    <div className="flex flex-col">
      ...
      <section style={{ background: "#f7f2eb" }} className="py-16">
        <div className="max-w-[1280px] mx-auto px-4 flex flex-col items-center text-center gap-4">
          ...
          <p className="text-[16px] text-dv-muted max-w-[480px] leading-relaxed">
            Join us for inspiring exhibitions, hands-on workshops, and community
            gatherings celebrating the power of art and creativity.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-[1280px] mx-auto px-4 py-10 w-full">
        ...
        {/* Tabs */}
        <div
          className="inline-flex border border-black/12 rounded-full p-1 mb-10"
          ...
          {(["upcoming", "past"] as const).map((tab) => (
            <button
              ...
              className={`px-6 h-9 rounded-full text-[14px] font-medium transition-all ${
                activeTab === tab
                  ? "bg-white text-dv-text shadow-sm"
          ...
          <>
            ...
            {featured.length > 0 && (
              <section className="mb-14">
                <h2 className="font-serif italic text-dv-accent text-[28px] mb-6">
                  Featured Events
                </h2>
                  ...
                  {featured.map((event) => (
                    ...
                    >
                      ...
                      <div className="p-6 flex flex-col gap-4">
                        ...
                        <span
                          className="w-full h-11 rounded-full bg-dv-accent text-white text-[15px] font-medium flex items-center justify-center gap-1.5 group-hover:opacity-90 transition-opacity"
                        >
                          Register Now →
                        </span>
                      </div>
                ...
                {upcoming.map((event) => (
                  ...
                  >
                    ...
                    <div className="p-4 flex flex-col gap-3">
                      <h3 className="text-[15px] font-semibold text-dv-text leading-snug">
                        {event.title}
                      </h3>
                      ...
                      <span
                        className="w-full h-9 rounded-full bg-dv-accent text-white text-[13px] font-medium flex items-center justify-center group-hover:opacity-90 transition-opacity"
                      >
                        Register
                      </span>
                    </div>
        ...
        >
          ...
          <p className="text-[15px] text-dv-muted max-w-[440px] leading-relaxed">
            Subscribe to our newsletter to get updates about upcoming workshops,
            exhibitions, and special events.
          </p>
          <form
            onSubmit={(e) => e.preventDefault()}
            className="flex gap-2 w-full max-w-[420px]"
          >
            <input
              type="email"
